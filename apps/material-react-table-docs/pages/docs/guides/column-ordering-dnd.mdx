...
const table = useMaterialReactTable({
  ...
  initialState: {
    columnOrder: [
      ...
      'city',
      'country',
      '__check__', //move the built-in selection column to the end of the table
    ],
  },
});
...
const [columnOrder, setColumnOrder] = useState(
  ['__check__', ...columns.map((c) => c.accessorKey)], //array of column ids (Initializing is optional as of v2.10.0)
);
