...
export const MRT_Localization_FR: MRT_Localization = {
  ...
  deselectAllOnAllPages: 'Désélectionner tout sur toutes les pages',
  deselectAllOnCurrentPage: 'Désélectionner tout sur la page actuelle',
  ...
  filterFromToday: "À partir d'aujourd'hui",
  filterToToday: "Jusqu'à aujourd'hui",
  ...
  select: 'Sélectionner',
  selectAllOnAllPages: 'Sélectionner tout sur toutes les pages',
  selectAllOnCurrentPage: 'Sélectionner tout sur la page actuelle',
  ...
  dimensionRotationEnabled: 'Rotation activ�e',
  dimensionRotationDisabled: 'Rotation d�sactiv�e',
};
