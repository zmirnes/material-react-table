...
export const MRT_Localization_HR: MRT_Localization = {
  ...
  filterGreaterThanOrEqual: 'Veće od ili jednako',
  ...
  filterLessThanOrEqual: 'Manje od ili jednako',
  ...
  thenBy: ', zatim po ',
  toggleDensity: 'Gustoća',
  densityCompact: 'Kompaktan',
  densityStandard: 'Standard',
  densityComfortable: 'Udobno',
