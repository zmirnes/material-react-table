...
export const MRT_Localization_NL: MRT_Localization = {
  ...
  filterEqualsNumber: 'Is gelijk aan',
  filterIs: 'Is',
  filterNot: 'Is niet',
  filterBefore: 'Voor',
  filterAfter: 'Na',
  ...
  filterGreaterThanOrEqual: 'Groter dan of gelijk aan',
  ...
  filterLessThanOrEqual: 'Kleiner dan of gelijk aan',
  ...
  exportSelectRowsTooltip: 'Selecteer rijen om te exporteren',
