...
> = {
  ...
  currentMonth: 'filterCurrentMonth',
  currentWeek: 'filterCurrentWeek',
  endsWith: 'filterEndsWith',
  equals: 'filterEquals',
  equalsNumber: 'filterEqualsNumber',
  'from-today': 'filterFromToday',
  fromToday: 'filterFromToday',
  ...
  last7Days: 'filterLast7Days',
  lastMonth: 'filterLastMonth',
  lastWeek: 'filterLastWeek',
